...
print("Wnioski: Dla zmiennych X1, X4 oraz X7 współczynnik VIF jest mniejszy od 10. Zmienne te charakteryzują się brakiem współliniowości, a więc nie są ze sobą silnie skorelowane.")