...
plt.text(0.5, 0.9, "Wniosek: Widać dużą korelację między Y a X1",
...
plt.text(0.5, 0.9, "Wniosek: Widać dużą korelacji między Y a X2",
         horizontalalignment='center', verticalalignment='center', transform=plt.gca().transAxes)
plt.show()
...
plt.text(0.5, 0.9, "Wniosek: Słabe zróżnicowanie danych",
         horizontalalignment='center', verticalalignment='center', transform=plt.gca().transAxes)
plt.show()