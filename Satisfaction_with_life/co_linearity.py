...
print("Wnioski: Dla zmiennych X4 i X5 współczynnik VIF jest mniejszy od 10. Zmienne te charakteryzują się brakiem współliniowości, a więc nie są ze sobą silnie skorelowane.")